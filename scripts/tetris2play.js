var tetris = {
    ...
    drawBoard : function() {
        ...
        for(var y=0; y <= 21; y++) {// every row
            for(var x=0; x<= 9; x++) { //go through every block in the row
                if(this.boardPosition[x][y] !== 0){
                    ...
                    draw.draw(1 + x * 24, 1 + (y - enemyBoard.playerGarbage) * 24, 0, 0, color, tetrisBoard.canvas);
                }
            }
        }
        //draw garbage
        for(var y=21; y > 21 - enemyBoard.playerGarbage; y--) {// every row
            for(var x=0; x<= 9; x++) { //go through every block in the row
                draw.draw(1 + x * 24, 1 + (y) * 24, 0, 0, "#d3d3d3", tetrisBoard.canvas);
            }
        }
    ...
    spawnPiece : function() {
        ...
        if(key.pressed[key.down] > 0) {
            ...
            if(!tetris.piece.checkCollision(1)){
                ...
                tetris.piece.interval = setInterval(tetris.piece.gravityInterval, 30);
            }
        }
    ...
    pieceObject : function(x, y, pieceName, color, rotations) {
        ...
        this.update = function () {
            ...
            for(var i = 0; i <= 3; i++) {
                ...
                draw.draw(1 + (tetris.piece.x) * 24, 1 + (tetris.piece.y - enemyBoard.playerGarbage) * 24, xx, yy, color, tetrisBoard.canvas);
            }
    ...
    ghostObject : function(color) {
        ...
        this.update = function() {
            ...
            for(var i = 0; i <= 3; i++) {
                ...
                draw.draw(1 + (this.x) * 24, 1 + (this.y - enemyBoard.playerGarbage) * 24, xx, yy, this.color, tetrisBoard.canvas);
